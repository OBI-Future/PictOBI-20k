...
with open('./quiz_reference_point.json', 'r') as file:
    ...
    output_result = './qwen25-vl-72B-refpoint.csv'
    count = 0
            ...
            messages = [
                {
                    ...
                    "content": [
                        {
                            "type": "image",
                            "image": "./reference_point_quiz/"+subfolder+'/'+OBC_image[:-4]+'_REF1_annotated.png',
                        }, 
                        {
                            "type": "image",
                            "image": "./reference_point_quiz/"+subfolder+'/'+object_image[:-4]+'_final_annotated.png',
                        },
                        {"type": "text", "text": "Given an Oracle bone character image <image> and a real object image <image> \n \
